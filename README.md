...
An additional example of running simple phylogenetic models is [here (in .pdf)](https://github.com/TGuillerme/mulTree/blob/master/doc/Advanced_phylogenetic_analyses.pdf).
