...
You should have come across pgls models earlier today from the \href{https://cran.r-project.org/web/packages/caper/vignettes/caper.pdf}{caper package see here}
...
First we need to install some packages including the ape and caper packages that run the pgls models and the MCMCglmm package to run the Bayesian version of a phylogenetic comparative analysis.
