...
mulTree(mulTree.data = mulTree_data, formula = my_formula,
     parameters = my_parameters, priors = my_priors,
     output = "longevity_example", ESS = 50, chains = 2)
@
...
<<plot.mulTree1, fig.width=8, fig.height=8, out.width='.8\\linewidth'>>=
## Plotting using the default options
plot(summarised_results)
@ 

<<plot.mulTree2, fig.width=8, fig.height=8, out.width='.8\\linewidth'>>=
